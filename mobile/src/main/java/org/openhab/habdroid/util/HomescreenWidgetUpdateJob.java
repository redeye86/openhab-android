...
public class HomescreenWidgetUpdateJob extends AsyncTask {
    private static final String TAG = HomescreenWidgetUpdateJob.class.getSimpleName();
    ...
    public HomescreenWidgetUpdateJob(Context context, AppWidgetManager appWidgetManager,
                               int appWidgetId){
    ...
    public HomescreenWidgetUpdateJob(Context context, int appWidgetId){
        this.context = context;
    ...
    protected Map<String, Object> doInBackground(Object[] params) {
            ...
            String icon = HomescreenWidgetUtils.loadWidgetPrefs(context, appWidgetId, "icon");
            String name = HomescreenWidgetUtils.loadWidgetPrefs(context, appWidgetId, "name");

            JSONObject item = HomescreenWidgetUtils.getJSONObjectFromURL(context, "rest/items/" + name);

            String state = "";

            try {
                state = item.getString("state");
                HomescreenWidgetUtils.saveWidgetPrefs(context, appWidgetId, "lastState", state);
            ...
            if(state.equals("OFF")) {
                iconBitmap = HomescreenWidgetUtils.toGrayscale(iconBitmap);
            }
    ...
    protected void onPostExecute(Object o) {
        ...
        if(name != null) {
            String label = HomescreenWidgetUtils.loadWidgetPrefs(context, appWidgetId, "label");
            ...
            try {
                ...
                if(stateDescription == null || !stateDescription.getBoolean("readOnly")) {
                    ...
                    Intent active = new Intent().setClass(context, HomescreenWidgetProvider.class);
                    active.setAction(HomescreenWidgetProvider.ACTION_BUTTON_CLICKED);
